...
//		sum = (args) -> Arrays.stream(args).reduce(0, Integer::sum);
		...
		div = (args) -> Arrays.stream(args).boxed().sorted((a, b) -> b - a).reduce(1, (a, b) -> {
			if (a == 0 || b == 0)
				return 0;
			return a < b ? b / a : a / b;
		});
...
public class C02Ex {
	...
	public static void main(String[] args) {
		...
		Calc calc = new Calc();
		System.out.println("덧셈 : " + calc.sum.execute(10, 20, 30, 40, 50, 60));
		System.out.println("뺄셈 : " + calc.sub.execute(1, 4, 2, 9));
		System.out.println("곱셈 : " + calc.mul.execute(10, 20, 30, 40, 50, 60));
